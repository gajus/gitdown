...
Is there anything that Gitdown doesn't do already that would streamline the documentation maintenance? [Raise an issue](https://github.com/gajus/gitdown/issues).
